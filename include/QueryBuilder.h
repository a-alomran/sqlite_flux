...
namespace sqlite_flux
{
    ...
    public:
        ...
        // Filter methods
        QueryBuilder& Filter(const std::string& column_, const ColumnValue& value_);
        QueryBuilder& Filter(const std::string& column_, const ColumnValue& value_, CompareOp op_);

        // Ordering
        QueryBuilder& OrderBy(const std::string& column_, bool ascending = true);
    ...
    // ============================================================================
    // Forward declarations for DML builders
    // ============================================================================
    ...
    public:
        ...
        // INSERT operations
        InsertBuilder InsertInto(const std::string& tableName);

        // UPDATE operations
        UpdateBuilder UpdateTable(const std::string& tableName);

        // DELETE operations
        DeleteBuilder DeleteFrom(const std::string& tableName);
